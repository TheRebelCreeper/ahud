...
"resource/ui/hudpasstimeballstatus.res"
{
	...
	"BlueProgressEnd"
	{
		// tells the code where the end of the progress bar is since the image might be padded for npot reasons.
		"ControlName" 	"Panel"
	...
	"BallPowerCluster"
	{
		...
		{
			// This exists because the bar is filled by changing the width dynamically and if you change the width of the ImagePanel, it will stretch the image.
			// But if you instead change the width of this container, the image is simply cut off instead of stretched.
